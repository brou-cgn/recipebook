...
describe('button icon dark-mode resolution', () => {
  ...
  test('includes configurable default entries for bottom navigation icons, active icons and their dark variants', () => {
    ...
    expect(DEFAULT_BUTTON_ICONS.bottomNavHomeActive).toBe('');
    expect(DEFAULT_BUTTON_ICONS.bottomNavRecipesActive).toBe('');
    expect(DEFAULT_BUTTON_ICONS.bottomNavMenusActive).toBe('');
    expect(DEFAULT_BUTTON_ICONS.bottomNavAtelierActive).toBe('');
    expect(DEFAULT_BUTTON_ICONS.bottomNavChefActive).toBe('');
    ...
    expect(DEFAULT_BUTTON_ICONS.bottomNavHomeActiveDark).toBe('');
    expect(DEFAULT_BUTTON_ICONS.bottomNavRecipesActiveDark).toBe('');
    expect(DEFAULT_BUTTON_ICONS.bottomNavMenusActiveDark).toBe('');
    expect(DEFAULT_BUTTON_ICONS.bottomNavAtelierActiveDark).toBe('');
