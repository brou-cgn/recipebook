...
export const DARK_MODE_ICON_ROWS = [
  ...
  { key: 'timelineMenuDefaultImg', label: 'Zeitleiste: Standardbild für Menüs' },
  { key: 'timelineBubbleIcon', label: 'Zeitleisten-Icon (Rezepte)' },
  { key: 'timelineMenuBubbleIcon', label: 'Zeitleisten-Icon (Menüs)' },
  { key: 'timelineCookEventBubbleIcon', label: 'Zeitleisten-Icon (Kochereignisse)' },
...
const BUTTON_ICON_GROUP_DEFS = [
  ...
  { id: 'g-rezept-details', name: 'Rezept-Details', keys: ['nutritionEmpty', 'nutritionFilled', 'nutritionRecalc', 'ratingHeartEmpty', 'ratingHeartEmptyModal', 'ratingHeartFilled', 'cookDate', 'printRecipe', 'deleteRecipe', 'newVersion', 'recipeSourceLink', 'addImage', 'resetThumbnail'] },
  ...
  { id: 'g-tagesmenu', name: 'Menü & Tagesmenü', keys: ['menuFavoritesButton', 'privateBadge', 'tagesmenuZumTagesMenu', 'tagesmenuMeineAuswahl', 'tagesmenuKachelMenu', 'tagesmenuKachelMenuAlt', 'timelineMenuDefaultImg'] },
  { id: 'g-zeitleiste', name: 'Zeitleiste', keys: ['timelineBubbleIcon', 'timelineMenuBubbleIcon', 'timelineCookEventBubbleIcon'] },
